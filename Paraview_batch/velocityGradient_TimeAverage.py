...
## Purpose: To compute time averaging of velocity gradient for a specific chosen time steps
...
airfoilOpenFOAM.CellArrays = ['grad(U)']
...
SaveData('/home/bhanu/airfoil/PSgradscript.csv', proxy=plotData1, Precision=8)
