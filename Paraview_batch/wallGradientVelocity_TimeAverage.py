...
## Purpose: To compute time averaging of wall gradient of velocity for a specific chosen time steps
...
airfoilOpenFOAM.CellArrays = ['wallGradU']
...
SaveData('/home/bhanu/airfoil/PSwallgradscript.csv', proxy=plotData1, Precision=8)
